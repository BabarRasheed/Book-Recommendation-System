...
# try:
#     # Open the pickle file and load its content directly
...
#     user_imput = request.form.get('user_input')
#     index = np.where(pt.index == user_imput)[0][0]
...
#         print(f"Book not found: {user_input}")  # Debugging statement
